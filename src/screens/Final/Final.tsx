      ...
      <div className="bg-white w-full max-w-[1440px]">
        {/* Hero Banner Section */}        <header className="container mx-auto px-4 pt-10 ">
          <Link to="/" className={`inline-block ${fadeIn}`}>            <img
              ...
              loading="lazy"
            />
          </Link>        </header>        <section className="container mx-auto px-4 py-4 md:py-10">          <Card className="w-full h-auto md:h-[580px] bg-[#5279f6] rounded-[30px] border-none relative overflow-hidden"><CardContent className="p-0">            <div className="w-full h-[580px] md:h-[578px] md:px-[15px] bg-[url(/HeroBannerBG.png)] bg-cover bg-center md:bg-[100%_100%] relative flex flex-col items-center md:block"><div className={`text-center md:text-left mt-10 md:mt-0 md:absolute md:top-[124px] md:left-[39px] [font-family:'Open_Sans'] font-bold text-white text-[28px] md:text-[42px] tracking-[0] leading-tight md:leading-[1.05] md:max-w-[50%] z-10 ${slideInFromLeft}`}>
        ...
        <section className={`container mx-auto px-4 py-6 md:py-14 ${fadeIn} ${delay400}`}>          <h2 className="text-center text-[26.5px] md:text-[42px] text-[#416af6] font-normal mb-6 md:mb-12">
          ...
          <h2 className="text-[32px] md:text-[42px] font-bold text-[#416AF6] mb-6 md:mb-10 text-left">
            References          </h2>
          ...
          </Card></section>{/* Disclaimer Section */}        <section className={`container mx-auto px-4 py-6 md:py-10 ${fadeIn} ${delay400}`}>          <h2 className="text-[32px] md:text-[42px] font-bold text-[#416af6] mb-3 md:mb-4 text-left">
            Disclaimer
          </h2>
          
          <div className="space-y-4">
            <p className="[font-family:'Open_Sans'] font-normal text-black text-sm md:text-base tracking-[0.20px] leading-6 text-left">
