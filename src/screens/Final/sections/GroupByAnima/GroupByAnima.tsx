...
export const GroupByAnima = (): JSX.Element => {
  return (
    <div className="w-full py-2 md:py-4 relative">
      {/* Mobile image */}
      <div className="relative md:hidden w-full h-[150px] flex justify-center mb-[-50px] z-10">
        <img
      ...
      <Card className="w-full bg-[#5279f6] rounded-[30px] border border-solid border-[#6e91f7] overflow-visible">
        <CardContent className="p-5 pt-[70px] md:pt-5 md:px-8 md:py-6 flex flex-col md:flex-row items-start text-center md:text-left">
          ...
          <div className="w-full md:w-[70%] space-y-3 md:pl-0">
