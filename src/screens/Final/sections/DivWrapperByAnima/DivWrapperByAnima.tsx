...
export const DivWrapperByAnima = (): JSX.Element => {
  return (    <Card className="w-full h-auto md:h-[300px] bg-[#416af6] rounded-[30px] overflow-visible border border-solid pb-0">
      <CardContent className="p-0 h-full relative">
        ...
        <div className="hidden md:block absolute left-[114px] bottom-0 z-10">
          ...
          />        </div>          <div className="pt-6 md:pt-6 pb-4 md:pb-0 px-4 md:pl-[498px] md:pr-6 relative z-10">
          ...
          </h2><p className="mt-[15px] md:mt-[20px] opacity-80 font-['Open_Sans',Helvetica] font-bold text-white text-base md:text-lg tracking-[0.20px] leading-normal md:leading-[27px] text-center md:text-left">            To know more about Meningococcal Vaccination before your travel.          </p>          <div className="flex justify-center md:justify-start mb-0.5 md:mb-0">
          ...
          {/* Mobile doctor image at the bottom */}        <div className="md:hidden w-full flex justify-center relative z-10" style={{ height: "280px" }}>
