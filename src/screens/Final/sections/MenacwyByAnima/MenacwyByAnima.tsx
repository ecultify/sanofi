...
export const MenacwyByAnima = (): JSX.Element => {
  ...
  <div className="p-6 font-['Open_Sans',Helvetica] text-[#3655C1] text-base tracking-[0.20px] leading-6">
    ...
    <ol className="list-decimal pl-5 space-y-1">
      ...
      <li className="break-words whitespace-normal">
        <a href="https://www.who.int/health-topics/meningitis#tab=tab_1" target="_blank" rel="noopener noreferrer" className="text-[#416AF6] underline break-words">https://www.who.int/health-topics/meningitis#tab=tab_1</a> Accessed on June 27, 2022.
      </li>
      <li className="break-words whitespace-normal">
        WHO. Meningococcal meningitis. Available at <a href="https://www.who.int/news-rooms/fact-sheets/detail/meningococcal-meningitis" target="_blank" rel="noopener noreferrer" className="text-[#416AF6] underline break-words">https://www.who.int/news-rooms/fact-sheets/detail/meningococcal-meningitis</a> Accessed February 2021
      </li>
      <li className="break-words whitespace-normal">
        Meningitis Research Foundation. What are meningitis and septicaemia. Available at <a href="https://www.meningitis.org/meningitis/what-is-meningitis" target="_blank" rel="noopener noreferrer" className="text-[#416AF6] underline break-words">https://www.meningitis.org/meningitis/what-is-meningitis</a> Accessed February 2021
      </li>
      <li className="break-words whitespace-normal">
